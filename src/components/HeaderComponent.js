    ...
    return(
        <header className="relative pb-28">
            <div className="flex flex-row items-center">
                ...
                <input type="text" className="z-0 border-2 border-gray-300 bg-white h-12 pl-12 rounded-lg text-sm focus:outline-none" placeholder="Search by name"/>
